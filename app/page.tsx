    ...
    <div className="min-h-screen bg-white">
      ...
      <section id="contact" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="font-sans text-base text-gray-500 mb-14 text-center max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 mb-14">
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group p-6 bg-white border border-gray-200 rounded-2xl hover:border-gray-300 hover:shadow-sm transition-all"
            >
              <div className="flex flex-col items-center text-center space-y-3">
                <div className="w-10 h-10 rounded-full flex items-center justify-center bg-gray-100 group-hover:bg-gray-200 transition-colors">
                ...
                <div>
                  <h3 className="font-serif text-base text-gray-800 mb-0.5">Adresă</h3>
                  <p className="font-sans text-sm text-gray-400">Strada Primăverii 6, Constanta</p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="flex flex-col items-center text-center space-y-3">
                ...
                <div>
                  <h3 className="font-serif text-base text-gray-800 mb-0.5">WhatsApp</h3>
                  <p className="font-sans text-sm text-gray-400">+40 XXX XXX XXX</p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="flex flex-col items-center text-center space-y-3">
                ...
                <div>
                  <h3 className="font-serif text-base text-gray-800 mb-0.5">Facebook</h3>
                  <p className="font-sans text-sm text-gray-400">@irinagospodaru</p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="flex flex-col items-center text-center space-y-3">
                ...
                <div>
                  <h3 className="font-serif text-base text-gray-800 mb-0.5">Instagram</h3>
                  <p className="font-sans text-sm text-gray-400">@irinagospodaru</p>
                </div>
              </div>
            </a>
