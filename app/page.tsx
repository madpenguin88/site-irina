...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Servicii Section */}
      <section id="servicii" className="py-20 px-6 relative">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <h2 className="font-serif text-4xl md:text-5xl text-black mb-4 text-center">
            Servicii
          </h2>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Service Card 1 */}
            <div className="bg-white/70 backdrop-blur-sm border border-gray-200 rounded-2xl p-8 hover:shadow-lg hover:bg-white/85 transition-all">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <a 
              ...
              className="bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl hover:border-gray-300 transition-all group"
            >
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div>
                  <h3 className="font-serif text-xl text-gray-900 mb-2">Adresă</h3>
                  <p className="font-sans text-sm text-gray-600">București, România</p>
                </div>
              </div>
            </a>
